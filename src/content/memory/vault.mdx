...
The vault tools are created through [`useChatStorage`](/sdk/react/Hooks/useChatStorage), which sets up the database context, authentication, and embedding cache automatically.
