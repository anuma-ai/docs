...
Pass tools through [`useChat`](/sdk/react/Hooks/useChat) for basic tool calling, or [`useChatStorage`](/sdk/react/Hooks/useChatStorage) for tool calling with message persistence.
