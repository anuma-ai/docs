...
[`useChatStorage`](/sdk/react/Hooks/useChatStorage) handles file processing automatically when you send messages with attachments. You can configure processing behavior:
